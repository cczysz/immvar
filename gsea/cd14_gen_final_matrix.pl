...
my @gene_set_types=("c1.all","c2.cgp","c2.cp.biocarta","c2.cp.kegg","c2.cp.reactome","c3.mir","c3.tft","c4.cgn","c4.cm","c5.bp","c5.cc","c5.mf","c6.all","c7.all", "hg.all", "horm");
my @sexes=("na_pos");
my %matrix;
...
#c7.all.top20_gene_sets.males.filter.nompval.0.05.matrix.txt
		...
		open ($out,'>',$fileout);
		print $out "Gene_set CD14.Meta CD14.Meta.Weight ImmVar.CD14\n";
