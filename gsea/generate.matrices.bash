...
sets="c1.all c2.cgp c2.cp.biocarta c2.cp.kegg c2.cp.reactome c3.mir c3.tft c4.cgn c4.cm c5.bp c5.cc c5.mf c6.all c7.all horm"
...
cd14study="meta.cd14_rep1.txt meta.all.cd14_weight1.txt immvar.CD14"
