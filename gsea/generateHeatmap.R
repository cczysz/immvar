...
for (gene_set_class in gene_set_classes) {
	for (sex in sexes) {
		...
		heatmap.2(mat, Rowv = FALSE, Colv = FALSE, dendrogram = "none", notecol = "black", notecex = 0.4,trace = "none", key = F, margins = c(7, 11),col=my_palette,cexCol = 1,cexRow=0.5,lhei=c(1,10));
